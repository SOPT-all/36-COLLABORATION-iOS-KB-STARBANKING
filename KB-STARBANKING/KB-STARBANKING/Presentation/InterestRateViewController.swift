...
class InterestRateViewController: UIViewController {
    ...
    private lazy var interestRateCollectionView = RateViewController()
    ...
    private func setLayout() {
        [titleLabel,cancelButton,accountLabel,blueLineView,accountNumberLabel,accountDivView,durationLabel, durationInfoLabel,newDateLabel, newDateInfoLabel,
            endDateLabel, endDateInfoLabel,accountDivView2, basicrateLabel, rateinfoLabel,
            rateTableHeaderStack,rateTableValueStack,preferLabel,interestRateCollectionView,
            cautionLabel, caution2Label].forEach {
